...
##
## get all night in which object has been observed
sqlite3 $dbfile "select distinct grating from trecs where ra between $ra_min and $ra_max and dec between $dec_min and $dec_max;"